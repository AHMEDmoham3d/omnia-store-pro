...
Its scent is warm and woody with a light touch of sweetness and citrus
  ...
  },
  {
    ...
    description: `السايج يُستخدم منذ قرون في طقوس التطهير وتنقية الطاقة. 
رائحته قوية عشبية منعشة تساعد في تحرير الطاقات الثقيلة واستعادة التوازن للمكان والهالة.
...
//   },
  {
    ...
    description: `أوراكل أسماء الله الحسنى - أداة ذكر وتجربة روحانية عميقة. 
99 بطاقة تجمع الروحانية وعلم الأرقام مع شرح كامل ودليل استخدام.
