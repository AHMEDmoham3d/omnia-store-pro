    ...
    <>
      ...
      <section className="section" id="incense">
        ...
        <div className="products-grid">
          {products.filter(p => p.category === 'incense').map(product => (
            <ProductCard
              key={product.id}
              product={product}
              onClick={() => {
      ...
      <section className="section" id="oils">
        ...
        <div className="products-grid">
          {products.filter(p => p.category === 'oils').map(product => (
            <ProductCard
              key={product.id}
              product={product}
              onClick={() => {
      ...
      <section className="section" id="cards">
        ...
        <div className="products-grid">
          {products.filter(p => p.category === 'cards').map(product => (
            <ProductCard
              key={product.id}
              product={product}
              onClick={() => {
      ...
      <section className="section" id="carpets">
        ...
        <div className="products-grid">
          {products.filter(p => p.category === 'carpets').map(product => (
            <ProductCard
              key={product.id}
              product={product}
              onClick={() => {
